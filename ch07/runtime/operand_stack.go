...
func (self *OperandStack) PopFloat() float32 {
	self.size--
	bits:=uint32(self.slots[self.size-1].num)
...
func (self *OperandStack) GetRefFromTop(argSlotCount uint) *heap.Object {
	return self.slots[self.size-1-argSlotCount].ref
}
